<section class="accordion nav_width bg-dark">
    <div class="nav_wrapper">
        <div class="navbar-brand d-flex justify-content-center align-content-center text-light">
            <div class="p-3"><a href="mainpage.php">.<span class="title_m">M</span>oovie</a></div>
        </div>
        <div class="bg-gradient-dark" id="accordionExample">
            <div class="card bg-dark text-right">
                ...
                <div id="collapse1" class="collapse <?= $groupname == "member"?"show":""; ?>" aria-labelledby="heading1"
                    ...
                    <div class="card-body">
                        <ul class="text-light">
                            <li class="<?= $pagename == "member_list"?"thisPage":""; ?>"><a href="Su_member_list.php">會員總覽</a></li>
            ...
            <div class="card bg-dark text-right">
                ...
                <div id="collapse3" class="collapse <?= $groupname == "film"?"show":""; ?>" aria-labelledby="heading3"
                    ...
                    <div class="card-body">
                        <ul>
                            <li class="<?= $pagename == "article_search"?"thisPage":""; ?>"><a href="film_data_list.php">影片總覽</a></li>
                            <li><a href="">影片清單</a></li>
...
<div class="pos-f-t">
    <nav class="navbar d-flex justify-content-end">
        <div class="navbar-brand d-flex justify-content-center align-content-center text-dark">
            <div class=""><a href="mainpage.php">.Moovie</a></div>
        </div>
        <button class="navbar-toggler" type="button" data-toggle="collapse"
            data-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false"
            aria-label="Toggle navigation" ><input type="checkbox" class="menu-box" id="menu-control" />
<label class="menu-button" for="menu-control">
