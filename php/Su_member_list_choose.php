    ...
    <form name="form1" method="post" action="" onsubmit="return checkForm()">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                    <input type="checkbox" class="custom-control-input" id="pwd_err_c" name="chk[]" value="pwd_err_c"
                        onclick="check(this,'all','chk[]')">
                ...
                <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                    <input type="checkbox" class="custom-control-input" id="login_c" name="chk[]" value="login_c"
                        onclick="check(this,'all','chk[]')">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-2  d-flex justify-content-center">
                <button id="submit_btn" type="submit" class="btn btn-primary btn-block my-3">產生資料</button>
            </div>
        </div>
