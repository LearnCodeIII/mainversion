                                    ...
                                    <div class="input-group-prepend mr-3">
                                        ...
                                        <div class="ml-3 mt-2 mb-2">
                                            <div class="form-check form-check">
                                                <input class="form-check-input" type="radio" id="signNo" value="no" name="signup[]" checked>
                                            ...
                                            <div class="form-check form-check-inline">
                                                ...
                                                <input class="form-check-input ml-1" type="text" id="signOtherNumber"  name="signup[]" size="3">
                                                <label class="form-check-label">人。</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
