...
<section class="dashboard">
  <div class="row mx-3">
    <button id="hideSrchbar" class="btn btn-info" style="color:white " data-toggle="collapse" data-target="#searchbar"
      aria-expanded="true" aria-controls="searchbar">打開搜尋列</button>

    <div class="card col collapse" id="searchbar">
      <div class="card-body">
        <form name="form1" method="post" action="" onsubmit="return checkForm()">
          <div id="step1" class="alert alert-primary text-center position-relative" role="alert" data-toggle="collapse"
            data-target="#set_condition" aria-expanded="true" aria-controls="set_condition">
            STEP-(1)設定搜尋條件
          ...
          <div class="col-lg-12 show" id="set_condition">
            <div class="row justify-content-center">
              ...
              <div class="col-lg-9">
                <input type="text" class="form-control mb-2 mr-sm-2" id="" name="sel-1-k" placeholder="請填入關鍵字">
              </div>
            </div>

            <div class="row justify-content-center">
              <label class="col-lg-3 col-sm-5 form-check form-control" for="">性別</label>
              <div class="col-lg-9 d-flex align-items-center">
                <div class="col-lg-2 col-sm-5 form-check">
                  <input class="form-check-input" type="radio" id="both" name="sel-2-k" value="男','女" checked>
                ...
                <div class="col-lg-2 col-sm-5 form-check">
                  <input class="form-check-input" type="radio" id="female" name="sel-2-k" value="女','">
          ...
          <div id="step2" class="alert alert-primary text-center mt-3 position-relative" role="alert"
            data-toggle="collapse" data-target="#set_column" aria-expanded="true" aria-controls="set_column">
            STEP-(2)選擇顯示的資料欄位
            ...
            <div class="col-lg-12">
              <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input" id="all" name="all"
                  onclick="check_all('chk[]',this)" checked>
              ...
              <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input" id="name" name="chk[]" value="name"
                  onclick="check(this,'all','chk[]')" checked>
                <label name="name" class="custom-control-label" for="name">姓名</label>
              </div>
              <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input" id="nickname" name="chk[]" value="nickname"
                  onclick="check(this,'all','chk[]')" checked>
                <label name="nickname" class="custom-control-label" for="nickname">暱稱</label>
              </div>
              <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input" id="gender" name="chk[]" value="gender"
                  onclick="check(this,'all','chk[]')" checked>
              ...
              <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input" id="birthday" name="chk[]" value="birthday"
                  onclick="check(this,'all','chk[]')" checked>
                <label name="birthday" class="custom-control-label" for="birthday">生日</label>
              </div>
              <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input" id="email" name="chk[]" value="email"
                  onclick="check(this,'all','chk[]')" checked>
                <label name="email" class="custom-control-label" for="email">email</label>
              </div>
              <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input" id="mobile" name="chk[]" value="mobile"
                  onclick="check(this,'all','chk[]')" checked>
                <label name="mobile" class="custom-control-label" for="mobile">手機</label>
              </div>
              <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input" id="fav_type" name="chk[]" value="fav_type"
                  onclick="check(this,'all','chk[]')" checked>
                <label name="fav_type" class="custom-control-label" for="fav_type">電影喜愛類型</label>
              </div>
              <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input" id="avatar" name="chk[]" value="avatar"
                  onclick="check(this,'all','chk[]')" checked>
                <label name="avatar" class="custom-control-label" for="avatar">頭像</label>
              </div>
              <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input" id="join_date" name="chk[]" value="join_date"
                  onclick="check(this,'all','chk[]')" checked>
              ...
              <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input" id="last_login_d" name="chk[]" value="last_login_d"
                  onclick="check(this,'all','chk[]')" checked>
              ...
              <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" class="custom-control-input" id="permission" name="chk[]" value="permission"
                  onclick="check(this,'all','chk[]')" checked>
  ...
  <div class="row d-flex justify-content-center sticky-top bg-light">
...
<script>
  ...
  const checkForm = () => {
    ...
    fetch("Su_member_blacklist_api.php?page=" + page, {
      method: 'POST',
      body: form
    })
      .then(res => {
