    ...
    <form name="form1"  method="post" action="" onsubmit="return checkForm()">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <div class="col-lg-2 custom-control custom-checkbox custom-control-inline">
                    <input type="checkbox" class="custom-control-input" id="sid" name="sid" value="sid" checked disabled>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-2  d-flex justify-content-center">
                <button id="submit_btn" type="submit" class="btn btn-primary btn-block my-3">產生黑名單</button>
            </div>
        </div>
...
const myHashChange = () =>{
    ...
    let form = new FormData(document.form1);
    fetch("Su_member_blacklist_choose_api.php?page="+page,{
            method:'POST',
            body:form
        })
    .then(res=>{
